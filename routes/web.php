...
Route::middleware(['auth'])->prefix('branch-manager')->name('branch-manager.')->group(function () {
    ...
    Route::post('/sales-report/{id}/reject', [BranchManagerController::class, 'rejectReport'])->name('sales-report.reject');
...
Route::middleware(['auth'])->prefix('staff')->name('staff.')->group(function () {
    ...
    Route::get('/inventory/all-products', [StaffController::class, 'getAllProducts'])->name('inventory.all-products');
